        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" id="app">
                    <input type="hidden" id="vista" value="getClientes">
                        ...
                        <table id="data-table" class="table table-striped table-bordered ">
                            ...
                            <tbody>
                                ...
                                {{--   <td>@{{data.created_at}}</td>  --}}
                                    <td>
                                        <form method="GET" id="frm-edit" v-on:submit.prevent="edit(data.id,'clientes')">
                                            <input type="submit" value="Editar"  class="btn btn-s">
                                        </form>
                                    </td>
                                    <td>
                                        <form method="POST" id="frm-delete" v-on:submit.prevent="drop(data.id,'clientes')">
                                            {{ csrf_field() }}
