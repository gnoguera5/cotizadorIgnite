...
@section('content')
    <h1 class="page-header">Servicios<small></small> </h1>
    <div class="row">
        <!-- begin col-12 -->
        <div class="col-md-12">
            <!-- begin panel -->
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" id="app">
                    ...
                    <input type="hidden" id="vista" value="getService">
                    ...
                    <div class="table-responsive">
                        <table  class="table table-striped table-bordered">
                            ...
                            <tr v-for="data in result">
                                ...
                                <td>@{{data.status}}</td>
                                <td>
                                    <form method="GET" id="frm-edit" v-on:submit.prevent="edit(data.id,'service')" style="display: inline">
                                        <button type="submit" data-toggle="tooltip" data-placement="bottom" title="Editar"  class="btn btn-s btn-primary">
                                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                        </button>
                                    </form>
                                    <button type="button" data-toggle="tooltip" @click="printTicketService(data.id)" class="btn btn-default" data-placement="bottom" title="Imprimir ticket">
                                        <span class="fa fa-ticket" aria-hidden="true"></span>
                                    </button>
                                    <form method="POST" id="frm-delete" v-on:submit.prevent="drop(data.id,'service')" style="display: inline">
                                        {{ csrf_field() }}
