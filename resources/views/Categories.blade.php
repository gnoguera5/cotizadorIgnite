        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-inverse">
                ...
                <div class="panel-body" id="app">
                    <input type="hidden" id="vista" value="getCategories">
                    <div class="input-group col-md-4">
                        <input type="text" v-model="search" class="form-control " placeholder="Buscar..">
                        <span class="input-group-addon"><i class="fa fa-search"></i></span>
                    </div> <br>
                    <a href="{{route('categorie.create')}}" class="btn btn-primary pull-right">Alta Categoría</a>
                    <br><br><br>
                    {{-- @{{$data}}
                     <ul>
                    ...
                    <div class="table-responsive">
                        <table  class="table table-striped table-bordered">
                            ...
                            <tr v-for="data in result">
                                ...
                                <td>
                                    <form method="GET" id="frm-edit" v-on:submit.prevent="edit(data.id,'categorie')" style="display: inline-block">
                                        <input type="submit" value="Editar"  class="btn btn-s">
                                    </form>
                                    <form method="POST" id="frm-delete" v-on:submit.prevent="drop(data.id,'categorie')" style="display: inline-block">
                                        {{ csrf_field() }}
