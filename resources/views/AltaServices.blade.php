            ...
            <div class="panel-body">
                ...
                <div id="app">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-4">
                            {!! Form::select('equipo', ['telefono'=>'Teléfono','tablet'=>'Tablet','pc'=>'PC','otros'=>'Otros'],null, ['class'=>'form-control
                            col-md-12']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-4">
                            {!! Form::text('marca', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Modelo</label>
                        <div class="input-group col-md-4">
                            {!! Form::text('modelo', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">No. serie</label>
                        <div class="input-group col-md-4">
                            {!! Form::text('noserie', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Accesorios</label>
                        <div class="input-group col-md-4">
                            {!! Form::textarea('accesorios', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-md-4">
                            {!! Form::textarea('reporte_del_cliente', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Respaldar</label>
                        <div class="input-group col-md-4">
                            {!! Form::textarea('respaldar', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Contraseña del equipo </label>
                        <div class="input-group col-md-4">
                            {!! Form::text('contrasenia_equipo', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Trabajo realizado</label>
                        <div class="input-group col-md-4">
                            {!! Form::textarea('trabajo_realizado', null, ['class'=>'form-control col-md-4']); !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">Estatus</label>
                        <div class="input-group col-md-4">
                            {!! Form::select('status', ['recibido'=>'Recibido','realizado'=>'Realizado','entregado'=>'Entregado'],null, ['class'=>'form-control
                            col-md-12']); !!}
                        </div>
                    </div>
